...
\033[0;36m  ╔═════\x1b[38;2;0;166;47════════════════════╦═\x1b[38;2;0;153;82═════════════\x1b[38;2;0;155;86══════════════╗
		...
		if sinput == "cls":
			...
			try:
				if running >= 20000:
					...
					threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
					os.system('cls')
					print("\033[91m[-] has sent packets to the server using a Transformer X Bumblebee.")
					time.sleep(1)
					os.system('cls')
					print("\033[91m[\] has sent packets to the server using a Transformer X Bumblebee..")
					time.sleep(1)
					...
					time.sleep(1)
					os.system('cls')
					print("\033[97m[/] has sent packets to the server using a Transformer X Bumblebee....")
					time.sleep(1)
					os.system('cls')
					print("\033[97m[+] has sent packets to the server using a Transformer X Bumblebee...")
					time.sleep(1)
